...
const projects = [
  ...
  { id: 5, title: "თანამედროვე მინიმალისტური რეზიდენცია", category: "საცხოვრებელი", location: "თბილისი", img: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=2070" },
  { id: 6, title: "ურბანული ბიზნეს ცენტრი", category: "კომერციული", location: "ბათუმი", img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070" },
  { id: 7, title: "კონტემპორარი ლოფტი", category: "ინტერიერი", location: "თბილისი", img: "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=2070" },
  { id: 8, title: "ეკო მეგობრული ვილა", category: "საცხოვრებელი", location: "საგურამო", img: "https://images.unsplash.com/photo-1510798831971-661eb04b3739?q=80&w=2070" },
];
...
const Projects = () => {
  ...
  return (
    <section className="py-32 bg-[#ffffff] text-[#1a1a1a]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        
        {/* სათაურის ბლოკი */}
        <div className="mb-24 space-y-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-zinc-100 pb-10 gap-6">
            <motion.div
            ...
            <div className="max-w-xs md:text-right text-zinc-400 text-sm font-light leading-relaxed">
          ...
          <div className="flex flex-wrap gap-8">
            {categories.map((cat) => (
              ...
              >
                {cat}
                <span className={`absolute -bottom-2 left-0 h-[1px] bg-black transition-all duration-500 ${
          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="relative aspect-[16/10] overflow-hidden bg-zinc-50 mb-8">
                  ...
                  <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full z-10 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                ...
                <div className="flex justify-between items-start border-t border-zinc-100 pt-6">
                  ...
                  <span className="text-zinc-200 font-serif italic text-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                    0{project.id}
                  </span>
                </div>
              </motion.div>
